...
import (
	...
	clusterv1alpha1 "github.com/open-edge-platform/cluster-connect-gateway/api/v1alpha1"
...
func main() {
	...
	flag.StringVar(&staticPodPath, "static-pod-path", "/var/lib/rancher/k3s/agent/pod-manifests/connect-agent.yaml", "The path where the connect-agent static pod manifest should be deployed.")
	...
	mgr, err := ctrl.NewManager(restConfig, ctrl.Options{
		...
		LeaderElectionID:       "97bf8c7b.edge-orchestrator.intel.com",
	...
	if err = agentconfig.InitAgentConfig(); err != nil {
		setupLog.Error(err, "failed to initialize initialize agent configs")
		os.Exit(1)
	}
	...
	setupLog.Info("starting manager", "connectionProbeTimeout", connectionProbeTimeout)
